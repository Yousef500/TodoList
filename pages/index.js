...
export default function Home() {
    ...
    const handleSaveList = async () => {
        ...
        if (user && todo.length > 0) {
            ...
            toast.error("Please make sure you're logged in and the list has tasks")
        }
    ...
    return (
        <Box sx={{overflowX: "hidden"}}>
            ...
            <Grid
                ...
                alignContent="center"
            >
                <Grid item xs={12} lg={5.5} mt={20} mb={2}>
                    <LoadingButton
                        variant="text"
                        color={"success"}
                        fullWidth
                ...
                <Grid item xs={6} lg={6.5}></Grid>

                <Grid item xs={12} lg={7} m={"auto"}>
                    <TextField
                        fullWidth
                        label="new task"
                        variant={"filled"}
